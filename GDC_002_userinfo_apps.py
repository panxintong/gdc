...
r=requests.get(url='https://gdc.game.line.me/games/channels/LGSDKTEST/appreview/ranking/appstore?appStoreDt=',
               headers=headers)

print(r.status_code)
print(r.text,type(r.text))
print(json.loads(r.text)['data']['appStoreRankingList'])
